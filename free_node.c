...
/**
 * add_to_node_end - adds a node to the end of the list
 * @head: address of pointer to head node
 * @str: str field of node
 * @num: node index used by history
 *
 * Return: size of list
 */
list_t *add_to_node_end(list_t **head, const char *str, int num)
{
 ...
 * Return: size of list
 */
size_t display_list_str(const list_t *first_node)
{
	size_t i = 0;
